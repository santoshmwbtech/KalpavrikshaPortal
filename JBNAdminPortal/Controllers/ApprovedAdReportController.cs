...
{
    public class ApprovedAdReportController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult LoadData(string FromDate, string ToDate, string ProductName)
        {
            ...
            var adMainReport = dLAdsReport.GetApprovedAdReport(searchOptions);
